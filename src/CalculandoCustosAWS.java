...
public class CalculandoCustosAWS {
    public static void main(String[] args) {
        ...
        //TODO: Calcule os custos
           double custoTotal;
           double custoBanco;
           double custoServidor;
            custoBanco = quantidadeBancosDados * custoPorHoraBancoDados;
            custoServidor = quantidadeServidores * custoPorHoraServidor;
            custoTotal = custoBanco + custoServidor;
